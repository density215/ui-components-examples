...
export class ProbesHexbinMap extends React.Component {
  ...
  componentDidMount() {
    const countries = loadCustomCountryGeoInfo({ countryId: "DEU" }).then(
      (countries) => {
        console.log("load them DEU kreise...");
    ...
    return (
      ...
      >
        <ProjectedPaths
          ...
          paths={
            this.state.probes && this.state.probes.filter((s) => s[5] === "DE")
          }
